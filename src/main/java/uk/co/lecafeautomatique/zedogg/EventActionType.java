...
public class EventActionType implements Serializable {
  ...
  public static EventActionType valueOf(String level) throws MsgTypeFormatException {
  ...
  static {
    _allDefaultLevels = new EventActionType[] { RECEIVE, SEND, ACKNOWLEDGE, UNKNOWN, CONNECT, ACCEPT, DISCONNECT,
        INTEREST, CREATE, DELETE, MODIFY, ADD, REMOVE, GRANT, REVOKE, PURGE, COMMIT, ROLLBACK, ROTATELOG };
